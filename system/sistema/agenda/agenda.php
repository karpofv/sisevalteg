                ...
                <table class="datatable table table-striped primary" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            $consultesis = paraTodos::arrayConsulta("*", "tesis_alumno tt, tesis t, linea  l, area a, periodo p, tools_periodo tp", "tt.tesal_cedula=$cedula and tt.tesal_tescodigo=t.tes_codigo and tp.tper_codigo=p.per_periodo and t.tes_linea=l.lin_codigo and t.tes_area=a.ar_codigo and t.tes_periodo=p.per_codigo");
                            foreach($consultesis as $tesis){
                        ?>
                            <tr>
                                <td><?php echo $tesis[per_anual]."-".$tesis[tper_descripcion]?></td>
